...
public class TVAppConfigure {
    ...
    public static final boolean isTestAccountInit = false;//测试账号初始化时使用，发布版本置为false
    public static final boolean isTestLogToFile = true;//测试使用 是否写log 到文件
    ...
    public static final String WIFI_AP_NAME = "HuiJianTV";//3288 盒子热点
    public static final String WIFI_AP_PWD = "12345678";//3288 盒子热点密码
    /******************************************
     * 外网环境
     **************************************************/
    ...
    public static String RESFUL_URL=TVAppConfigure.DO_MAIN+TVAppConfigure.pass_url_root;
    ...
    public static String CLIETN_TYPE = "android_tv";
    public static String CLIETN_TYPE_SYSTEM = "tv_system";//
...
//        public static final String stopTestingMic = "stopTestingMic"; //音频设置：停止测试麦克风
    ...
    public  static class PushType{
        public static final String ReservationMeetingPush ="ReservationMeeting";// 创建会议
        public static final String StartMeetingPush ="StartMeeting";// 开始会议
        public static final String EndMeetingPush ="EndMeeting";// 结束会议
        public static final String UpdateMeetingPush="UpdateMeeting";//修改会议
        public static final String InviteToMeetingPush="InviteToMeeting";//邀请
        public static final String RemovedInMeetingPush="RemovedInMeeting";//T出会议
        public static final String DeleteMeetingPush="DeleteMeeting";//删除会议
