...
public class UVCCameraHandlerMultiSurface extends AbstractUVCCameraHandler {
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
			final Activity parent, final CameraViewInterface cameraView,
			final int encoderType, final int width, final int height,int previewType) {
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
			final Activity parent, final CameraViewInterface cameraView,
			final int encoderType, final int width, final int height, final int format,int previewType) {
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
		...
		final CameraThread thread = new CameraThread(UVCCameraHandlerMultiSurface.class, parent, cameraView, encoderType, width, height, format, bandwidthFactor,previewType);
		thread.start();
