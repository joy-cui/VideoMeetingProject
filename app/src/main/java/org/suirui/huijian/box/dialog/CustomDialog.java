...
public class CustomDialog extends Dialog {
    private static final SRLog log = new SRLog(CustomDialog.class.getName(), AppConfigure.LOG_LEVE);
    ...
    private void init() {
        ...
        switch (isFroce) {
            case VersionConfigure.Version.isNForce:
                ...
                sr_version_num.setText(mContext.getResources().getString(R.string.sr_new_version) + versionNum);
            ...
            case VersionConfigure.Version.isReload:
                sr_version_num.setText(mContext.getResources().getString(R.string.sr_download_fail));
                sr_version_log.setText("");
                sr_btn_sure.setText(mContext.getResources().getString(R.string.sr_reload));
                sr_nofroce_update_layout.setVisibility(View.VISIBLE);
                sr_force_update_layout.setVisibility(View.GONE);
                this.setCancelable(true);
                break;
